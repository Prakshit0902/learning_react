...
// why use Link instead of a tag because when using a tag the page reloads and while using Link we just load the component required without 
// loading the complete code
